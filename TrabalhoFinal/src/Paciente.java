public class Paciente {
    ...
    public String toString() {
        return String.format("Código: %d, Nome: %s, Sexo: %c, Peso: %.2f kg, Altura: %.2f m, Idade: %d, IMC: %.2f, Peso Ideal: %.2f kg",
                codigo, nome, sexo, peso, altura, idade,imc(peso,altura),pesoIdael(altura,sexo) );
    }
}
